        ...
        <div class="swiper-wrapper">
            ...
            <div class="swiper-slide slide">
                ...
                <div class="content">
                    ...
                    <p>beauty products</p>
                    <div class="price">Tsh4999.99/= <span>Tsh7999.00/=</span></div>
                </div>
            </div>
    ...
    <div class="swiper arrivals-slider">
        ...
        <div class="swiper-wrapper">
            ...
            <div class="swiper-slide slide">
                ...
                <div class="content">
                    <p>beauty products</p>
                    <div class="price">Tsh4999/= <span>Tsh7999.00/=</span></div>
...
<section class="footer">
    ...
    <div class="box-container">
        ...
        <div class="box">
            <h3>contact info</h3>
            <p> <i class="fas fa-phone"></i> +255 656 507 409 </p>
            <p> <i class="fas fa-phone"></i> +255 656 507 409 </p>
            <p> <i class="fas fa-envelope"></i> elikanasumiye15@gmail.com </p>
            <p> <i class="fas fa-map"></i> Mbeya, Tanzania </p>
            <div class="share">
                <a href="#" class="fab fa-facebook-f"></a>
                <a href="#" class="fab fa-twitter"></a>
                <a href="#" class="fab fa-instagram"></a>
    ...
    <div class="credit"> created by <span>Elkana sumiye</span> | all rights reserved! </div>
